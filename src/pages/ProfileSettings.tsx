...
export default function ProfileSettings() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      const updatedData = {
        collegeName: selectedCollege ? selectedCollege.name : null,
        dteCode: selectedCollege ? selectedCollege.dteCode : null,
        branch,
        semester,
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 col-span-2 relative z-10">
              ...
              <SearchableCollegeDropdown
                ...
                onChange={(c) => {
                  ...
                  // Reset branch if not available in new college
                  if (c?.branches) {
            ...
            <div className="space-y-2 relative z-0">
              ...
              {selectedCollege?.branches && (
                 <p className="text-xs text-blue-600">Showing branches specific to {selectedCollege.name}</p>
              )}
            </div>
